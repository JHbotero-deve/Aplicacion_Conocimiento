...
const seed = async () => {
  try {
    ...
    await pool.query(
      "INSERT INTO ganado (chapeta, raza, edad, peso, fecha_ingreso, estadoica, certificado_ica, bloqueado) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) ON CONFLICT (chapeta) DO NOTHING",
      ["CH-001", "Holstein", 5, 450.50, "2026-05-01", "activo", true, false]
    );

    await pool.query(
      "INSERT INTO ganado (chapeta, raza, edad, peso, fecha_ingreso, estadoica, certificado_ica, bloqueado) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) ON CONFLICT (chapeta) DO NOTHING",
      ["CH-002", "Brahman", 3, 600.00, "2026-05-10", "activo", false, false]
    );

    await pool.query(
      "INSERT INTO ganado (chapeta, raza, edad, peso, fecha_ingreso, estadoica, certificado_ica, bloqueado) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) ON CONFLICT (chapeta) DO NOTHING",
      ["CH-003", "Jersey", 2, 200.00, "2026-05-15", "activo", true, false]
    );
